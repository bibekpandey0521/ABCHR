...
namespace Common.Authorization
{
    ...
    public class AppPermissions
    {
        private static readonly AppPermission[] _all = new AppPermission[]
        {
            ...
            new(AppFeature.Users,AppAction.Delete,AppRoleGroup.SystemAccess,"Create Users"),

            
            new(AppFeature.UsersRoles,AppAction.Read,AppRoleGroup.SystemAccess,"Read Users Roles"),
            new(AppFeature.UsersRoles,AppAction.Update,AppRoleGroup.SystemAccess,"Update Users Roles"),
            ...
            new(AppFeature.Employees,AppAction.Read,AppRoleGroup.ManagementHierachy,"Read Employees",IsBasic:true),
            new(AppFeature.Employees,AppAction.Create,AppRoleGroup.ManagementHierachy,"Create Employees"),
            new(AppFeature.Employees,AppAction.Update,AppRoleGroup.ManagementHierachy,"Update Employees"),
            new(AppFeature.Employees,AppAction.Delete,AppRoleGroup.ManagementHierachy,"Delete Employees")
